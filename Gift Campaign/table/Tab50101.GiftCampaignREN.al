/// <summary>
/// Table GiftCampaign_REN (ID 50101).
/// </summary>
table 50101 "GiftCampaign_REN"
{
    DataClassification = CustomerContent;
    DrillDownPageId = "Gift Campaign List_REN";
    LookupPageId = "Gift Campaign List_REN";
    ...
    fields
    {
        ...
        {
            DataClassification = CustomerContent;
            TableRelation = "Customer Category_REN";
